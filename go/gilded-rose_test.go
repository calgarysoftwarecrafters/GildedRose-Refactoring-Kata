...
func Test_ShouldUpdateItemCorrectlyFor30Days(t *testing.T) {
	var items = []*Item{
	...
	//TODO need to extend the feature to include Item{"Conjured Mana Cake", 3, 6},

	var sb strings.Builder
	days := 30
	for day := 0; day < days; day++ {
		sb.WriteString(fmt.Sprintf("-------- day %d--------\n", day))
		sb.WriteString(fmt.Sprintf("name, sellIn, quality\n"))
	...
	if sb.String() != expectedOutput() {
		t.Errorf("Name: Expected %s but got %s ", expectedOutput(), sb.String())
	}
}
